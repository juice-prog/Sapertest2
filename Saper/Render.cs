...
namespace NfSaper6
{
    public static class Render
    {
        ...
        public static void Square(Field field, int xPos, int yPos, Graphics e, Pen Pen, bool fill, bool mouseOnUnvisibleField)
        {
            ...
            {
                if (field.bombBoard[xPos, yPos].number == 9 && field.xFields * field.yFields - field.visibleFields == field.bombNumber) //выиг
                    e.FillRectangle(Brushes.LightGreen, rectangle);
                else if (field.bombBoard[xPos, yPos].number==9) 
                    e.FillRectangle(Brushes.Red, rectangle);
                else
        ...
        {
            Font drawFont = new Font("Областьь", 13);
         ...
         public static void AllBombFields(Field field, Graphics e, Pen Pen, int mouseX, int mouseY)
        {
            ...
            {
                if(field.bombBoard[mouseX, mouseY].visible == false && field.bombBoard[mouseX, mouseY].isFlag == true) 
                {
